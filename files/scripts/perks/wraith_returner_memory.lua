	...
	if ( storages ~= nil ) then
		for i,comp in ipairs( storages ) do
			...
			if ( name == "proj_file_apotheosis" ) then
				...
				if projectile ~= "data/entities/projectiles/deck/teleport_projectile.xml" and projectile ~= "data/entities/projectiles/deck/teleport_projectile_short.xml" and projectile ~= "mods/Apotheosis/files/projectiles/teleport_projectile_npc.xml" then

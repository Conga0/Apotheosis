...
if #victims > 0 then
    ...
    do target = victims[k].id
        local c = EntityLoad("mods/Apotheosis/files/entities/misc/pylon/pylon_buff_escium.xml")
        ...
        EntityLoad("mods/Apotheosis/files/entities/particles/circle_fast_escium.xml", this.x, this.y - 10)
        local targ_x,targ_y = EntityGetTransform(target)
        
        --Particle Effects at Target's location
        EntityLoad("mods/Apotheosis/files/entities/particles/circle_fast_escium.xml", targ_x, targ_y)

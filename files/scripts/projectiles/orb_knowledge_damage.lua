...
local orbcount = tonumber(GlobalsGetValue("DEBUG_ORBS"))--GameGetOrbCountThisRun() + tonumber( SessionNumbersGetValue("NEW_GAME_PLUS_COUNT") ) --Three-Eyed Orb? Kolmi-orb?

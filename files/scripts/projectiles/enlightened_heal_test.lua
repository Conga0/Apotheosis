...
for i=1,count do
	...
	shoot_projectile_from_projectile( entity_id, "mods/Apotheosis/files/entities/projectiles/enlightened_heal_test_proj.xml", px + Random( -5, 5 ), py + Random( -5, 5 ), vel_x, vel_y )
end

...
if projcomp ~= nil then
    ...
    if distance >= 15 then
	local eid = EntityLoad("data/entities/animals/tank_rocket.xml", pos_x, pos_y )
	...
	shoot_projectile_from_projectile(entity_id, "mods/Apotheosis/files/entities/projectiles/summon_tank_rocket.xml", pos_x, pos_y, vel_x, vel_y)
    end
end
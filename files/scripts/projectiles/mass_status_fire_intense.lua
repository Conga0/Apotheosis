...
local r = 512
local particlePath = "mods/Apotheosis/files/entities/misc/effect_status_fire_intense.xml"
if ModSettingGet( "Apotheosis.particle_reduction" ) then
	particlePath = "mods/Apotheosis/files/entities/misc/effect_status_fire_intense_lowparticles.xml"
end

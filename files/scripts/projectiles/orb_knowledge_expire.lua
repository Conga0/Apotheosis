...
local divine = ComponentGetValue2(spec, "image_file"):sub(43,43)=="d" -- e.g. mods/Apotheosis/files/particles/knowledge/4_2.png -> 4, cursed begins with d_ thus returns d==d true
local divine_cursed = ComponentGetValue2(spec, "image_file"):sub(43,44)=="dc" -- e.g. mods/Apotheosis/files/particles/knowledge/4_2.png -> 4, cursed begins with d_ thus returns d==d true
...
local pec = EntityAddComponent2(inner_glow, "ParticleEmitterComponent", {
	emitted_material_name=divine_cursed and "gold" or divine and "gold" or  cursed and "spark_red" or "spark_white",
...
for i=1, 4 do
	local pec2 = EntityAddComponent2(inner_glow, "ParticleEmitterComponent", {
		emitted_material_name=divine_cursed and "spark_red" or divine and "gold" or  cursed and "spark_red" or "spark_white",

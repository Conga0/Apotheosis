...
for i=1,count do
	...
	shoot_projectile_from_projectile( entity_id, "mods/Apotheosis/files/entities/projectiles/lukki_fire_tiny_firebolt.xml", px + Random( -5, 5 ), py + Random( -5, 5 ), vel_x, vel_y )
end

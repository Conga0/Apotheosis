table.insert(ALL_ENTITIES, {
  ...
  entities={
	  ...
	  },
	  {
		...
		path="data/entities/animals/parallel_apotheosis/boss_toxic_worm/boss_toxic_worm_parallel.xml",
		image="data/ui_gfx/animal_icons/boss_toxic_worm_parallel.png",
	  },
	  {
...
--[[
	  ...
	  },
	  {
		...
		path="data/entities/animals/shaman_greater_apotheosis.xml",
		image="data/ui_gfx/animal_icons/shaman_greater_apotheosis.png",
	  },
	  {
		name="Leaky Slime",
	  ...
	  {
		name="Snowman",
		path="data/entities/animals/snowman.xml",
		image="data/ui_gfx/animal_icons/snowman.png",
	  },
	  {
		name="Healing Spirit",
	  ...
	  },
	  {
		...
		path="data/entities/animals/wraith_returner_apotheosis.xml",
		image="data/ui_gfx/animal_icons/wraith_returner_apotheosis.png",
	  },
	  {
		name="Weirdo",
	  ...
	  {
		name="Portal Trap",
		path="mods/Apotheosis/files/entities/props/traps/trap_portal.xml",
		image="data/ui_gfx/building_icons/trap_portal.png",
	  },
	  {
		name="Suspended Fire Tank",
		path="mods/Apotheosis/files/entities/props/suspended_tank_fire.xml",
		image="data/ui_gfx/building_icons/suspended_tank_fire.png",
	  },
	  {
		name="Suspended Lava Tank",
		path="mods/Apotheosis/files/entities/props/suspended_tank_lava.xml",
	  ...
	  {
		name="Cat",
		path="mods/Apotheosis/files/entities/items/wands/custom/cat_wand.xml",
		image="data/ui_gfx/bubbles/cat_wand.png",
	  },
	  {
		name="Mana Battery",
		path="mods/Apotheosis/files/entities/items/wands/custom/mana_battery.xml",

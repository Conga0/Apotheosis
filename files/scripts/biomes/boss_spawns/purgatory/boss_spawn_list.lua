...
local xml = nxml.parse(content)
xml:first_of("mBufferedPixelScenes"):add_child(nxml.parse([[
    <PixelScene pos_x="-1167" pos_y="-1350" just_load_an_entity="mods/Apotheosis/files/entities/items/books/book_trophy_room_purgatory.xml" />
]]))
ModTextFileSetContent("mods/purgatory/files/biome/_pixel_scenes.xml", tostring(xml))
...
local xml = nxml.parse(content)
xml:first_of("mBufferedPixelScenes"):add_child(nxml.parse([[
    <PixelScene pos_x="4120" pos_y="1487" just_load_an_entity="mods/Apotheosis/files/entities/items/books/book_cat_rat.xml" />
]]))
ModTextFileSetContent("mods/purgatory/files/biome/_pixel_scenes.xml", tostring(xml))
...
local xml = nxml.parse(content)
xml:first_of("mBufferedPixelScenes"):add_child(nxml.parse([[
    <PixelScene pos_x="8610" pos_y="5500" just_load_an_entity="mods/Apotheosis/files/entities/buildings/fire_lukki_brimstone_detector.xml" />
]]))
xml:first_of("mBufferedPixelScenes"):add_child(nxml.parse([[
    <PixelScene pos_x="8419" pos_y="5500" just_load_an_entity="mods/Apotheosis/files/entities/buildings/fire_lukki_brimstone_detector.xml" />
]]))
xml:first_of("mBufferedPixelScenes"):add_child(nxml.parse([[
    <PixelScene pos_x="8610" pos_y="5500" just_load_an_entity="mods/Apotheosis/files/entities/buildings/fire_lukki_brimstone_detector.xml" />
]]))

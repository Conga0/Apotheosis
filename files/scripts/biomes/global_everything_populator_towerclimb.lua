...
if g_props then
    ...
    table.insert(g_props,
    {
        prob           = 0.07, --Originally 0.2, increased to compensate for opal crystals being added
        min_count    = 1,
        max_count    = 1,

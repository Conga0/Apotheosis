...
function init( x, y, w, h )
	LoadPixelScene( "data/biome_impl/dragoncave.png", "data/biome_impl/dragoncave_visual.png", x, y + 80, "data/biome_impl/dragoncave_background.png", true )
end
...
function spawn_dragonspot(x, y)
	EntityLoad( "data/entities/buildings/dragonspot.xml", x, y + 83 )
end
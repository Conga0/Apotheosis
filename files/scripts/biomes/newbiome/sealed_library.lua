...
g_small_enemies =
{
	...
	},
	{
		...
		min_count	= 1,
		max_count	= 1,    
		entity 	= "data/entities/animals/enchanted_books/enchanted_book_fire.xml"
	},
	{
		prob   		= 1.15,
		min_count	= 1,
		max_count	= 1,    
		entity 	= "data/entities/animals/enchanted_books/enchanted_book_wind.xml"
	},
	{
		prob   		= 1.15,
		min_count	= 1,
		max_count	= 1,    
		entity 	= "data/entities/animals/enchanted_books/enchanted_book_ice.xml"
	},
	{
		prob   		= 0.5,
		min_count	= 1,
		max_count	= 1,    
		entity 	= "data/entities/animals/enchanted_books/enchanted_book_lightning.xml"
	}
}

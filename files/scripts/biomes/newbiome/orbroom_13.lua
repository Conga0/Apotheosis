...
function spawn_orb(x, y)
	...
	spawn_material_checker( x - 197, y - 11, "apotheosis_magic_liquid_rideshare", "data/scripts/biomes/orbrooms/orbroom_shared.lua", "mods/Apotheosis/files/entities/glyphs/orbroom_13.xml", x, y - 100 )
	spawn_material_checker( x + 198, y - 11, "apotheosis_magic_liquid_rideshare", "data/scripts/biomes/orbrooms/orbroom_shared.lua", "mods/Apotheosis/files/entities/glyphs/orbroom_13.xml", x, y - 100 )

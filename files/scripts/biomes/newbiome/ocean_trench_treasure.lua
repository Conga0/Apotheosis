...
RegisterSpawnFunction( 0xff2fc6ec, "spawn_chest" )
...
function spawn_chest(x, y)
	EntityLoad("mods/Apotheosis/files/entities/items/pickups/chest_abyss.xml", x, y)
    --CreateItemActionEntity( "APOTHEOSIS_TERMINUS", x, y )
end

...
local enemy_list = { "drone_shield", "buildings/snowcrystal", "gazer_greater_cold", "gazer_robot", "ghost_bow", "giant_centipede", "ccc_bat_psychic", "devourer_ghost", "devourer_magic", "fairy_esoteric", "crypt/hideous_mass", "musical_being", "poring_holy", "poring_magic", "sentry", "shaman_greater_apotheosis", "tentacler_big", "whisp_big", "wizard_ambrosia", "wizard_firemage_greater", "wizard_z_poly_miniboss", "wraith_returner_apotheosis", "wraith_glowing", "wraith_storm", }
		...
		if ( target ~= "scavenger_heal" ) and ( target ~= "healerdrone_physics" ) then
			...
			if( damagemodels ~= nil ) then
				for i,damagemodel in ipairs(damagemodels) do
					local hp = tonumber( ComponentGetValue( damagemodel, "hp" ) ) * 10

...
function init(x, y, w, h)
	...
	local flags = 
	{
		{ { "pandora_chest_rain", "p_secret_pandora" }, { "clam_chest_rain", "p_secret_clam" }, { "musical_magic_played", "p_secret_musical_magic" }, { "boss_flesh_monster_gourd_holy", "p_boss_heretic_gourd_holy" } },

...
function init(x, y, w, h)
	...
	local flags = 
	{
		...
		{ { "dev_test_889", "p_ending_01" }, {"challenge_missingmagic_win", "p_ending_challenge_missingmagic"}, {"challenge_towerclimb_win", "p_ending_challenge_towerclimb"}, {"challenge_hardcore_win", "p_ending_challenge_hardcore"} },
		{ { "boss_toxic_worm", "p_boss_toxic" }, { "blob_boss", "p_boss_blob" }, { "musical_boss", "p_boss_music" }, {"boss_monolith", "p_boss_monolith"}, { "fire_lukki", "p_boss_fire_lukki" }, { "boss_flesh_monster", "p_boss_heretic" }, },

...
function init( x, y, w, h )
	...
	if pw == 0 then
		LoadPixelScene( "mods/apotheosis/files/biome_impl/end_game_02/empyrean/02.png", "mods/apotheosis/files/biome_impl/end_game_02/empyrean/02_visual.png", x, y, "", true )
	end
end

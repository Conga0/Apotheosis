...
local actionid = "action_apotheosis_alt_fire_teleport_short"
        ...
        if (mana > manacost) then
            ...
            if HasFlagPersistent(actionid) == false then
                ...
                if ModIsEnabled("quant.ew") then
                    CrossCall("apoth_ew_alt_fire", root, x, y, aim_x, aim_y, "data/entities/projectiles/deck/teleport_projectile_short.xml")
                end
        else

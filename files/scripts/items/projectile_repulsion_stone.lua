...
-- As it turns out, people randomly firing off blackholes tends to get things destroyed!
-- In rememberance of righooo who subsequently got demolished by a very very angry diamond...

if GameHasFlagRun("apotheosis_flesh_boss_stone_initiated") then

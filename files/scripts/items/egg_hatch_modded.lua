...
local entity_lists = 
{
	fairy = { {"fairy_big"}, {"fairy_big", 2}, {"fairy_big", 4}, {"fairy_esoteric"} },
	robot = { {"drone_mini", 3}, {"drone_status_ailment"}, {"roboguard"}, {"roboguard_big"} },
	mud = { {"mudman_friendly"}, {"mudman_friendly", 2} }
}

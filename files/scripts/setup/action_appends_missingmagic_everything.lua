...
local blacklist = {
    ...
    ["CHAINSAW"] = true,                         --02/01/2023 Conga: I feel nice today
    ["APOTHEOSIS_UPGRADE_ALWAYSCAST"] = true,    --11/01/2023 Conga: I feel nice today
...
for k=1,#actions do -- fast as fuck boi
    ...
    if not blacklist[v.id] and Random(1,6) == 1 then

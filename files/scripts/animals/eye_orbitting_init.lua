...
for i=1,8 do
    ...
    local eid = EntityLoad( "data/entities/animals/AI/eye_orbitting_minion.xml", x, y )
...
for k=1,#comps
do local v = comps[k]
	if ComponentGetValue2(v,"script_source_file") == "mods/Apotheosis/files/scripts/animals/eye_orbitting_init.lua" then

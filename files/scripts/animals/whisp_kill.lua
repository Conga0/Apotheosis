function damage_about_to_be_received(damage, x, y, entity_thats_responsible, critical_hit_chance)
    ...
    if EntityGetName(entity_thats_responsible) == "$enemy_apotheosis_whisp" or EntityGetName(entity_thats_responsible) == "$enemy_apotheosis_whisp_big" or EntityGetName(entity_thats_responsible) == "$enemy_apotheosis_whisp_giga" then
      local entity_id = GetUpdatedEntityID()
      local damage_model_comp = EntityGetFirstComponentIncludingDisabled(entity_id, "DamageModelComponent")

...
local xml = nxml.parse(content)
xml:first_of("mBufferedPixelScenes"):add_child(nxml.parse([[
    <PixelScene pos_x="4555" pos_y="727" just_load_an_entity="mods/Apotheosis/files/scripts/biomes/boss_spawns/purgatory/statue_room_populator_entity.xml" />
]]))
ModTextFileSetContent("mods/purgatory/files/biome/_pixel_scenes.xml", tostring(xml))
...
xml:first_of("mBufferedPixelScenes"):add_child(nxml.parse([[
  <PixelScene DEBUG_RELOAD_ME="0" clean_area_before="0" pos_x="11788" pos_y="2860" skip_biome_checks="1" skip_edge_textures="0"
    material_filename="mods/Apotheosis/files/pixel_scenes/essence_diamond/essenceroom_fungus.png"
...
xml:first_of("mBufferedPixelScenes"):add_child(nxml.parse([[
    <PixelScene pos_x="12044" pos_y="3116" just_load_an_entity="mods/Apotheosis/files/entities/items/pickups/essence_fungus.xml" />
]]))
ModTextFileSetContent("mods/purgatory/files/biome/_pixel_scenes.xml", tostring(xml))
...
local xml = nxml.parse(content)
xml:first_of("mBufferedPixelScenes"):add_child(nxml.parse([[
  <PixelScene pos_x="13086" pos_y="10970" just_load_an_entity="mods/Apotheosis/files/entities/props/hiddenmessage_hobo_glyph.xml" />
]]))
ModTextFileSetContent("mods/purgatory/files/biome/_pixel_scenes.xml", tostring(xml))

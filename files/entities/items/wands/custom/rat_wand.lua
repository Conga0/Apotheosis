...
local gun = { }
gun.name = {"$wand_apotheosis_rat_name"}
gun.deck_capacity = 1
...
gun.actions = {"apotheosis_RAT_BITE"}
...
AddGunActionPermanent( entity_id, "apotheosis_RAT_BITE")
...
ComponentSetValue2( item_comp, "item_name", "$wand_apotheosis_rat_name" )

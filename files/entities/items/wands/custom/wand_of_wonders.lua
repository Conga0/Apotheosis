...
local gun = { }
gun.name = {"$wand_apotheosis_wand_of_wonders_name"}
gun.deck_capacity = 25
gun.actions_per_round = 1
gun.reload_time = 5
gun.shuffle_deck_when_empty = 0
gun.fire_rate_wait = {10,25}
gun.spread_degrees = 0
gun.speed_multiplier = 1.33
gun.mana_charge_speed = {800,900}
gun.mana_max = {1200,1700}
...
AddGunActionPermanent( entity_id, "RANDOM_MODIFIER")
AddGunActionPermanent( entity_id, "RANDOM_MODIFIER")
AddGunActionPermanent( entity_id, "RANDOM_MODIFIER")
AddGunActionPermanent( entity_id, "RANDOM_MODIFIER")
AddGunActionPermanent( entity_id, "RANDOM_MODIFIER")
...
ComponentSetValue2( item_comp, "item_name", "$wand_apotheosis_wand_of_wonders_name" )

...
if( newgame_n % 7 == 0 ) then
	...
	if( temp == 0 ) then
		paint_replace_color( 60, 0, 0xFFCC9944 )
		paint_replace_color( 61, 0, 0xFFCC9944 )
	elseif( temp == 1 ) then
		paint_replace_color( 60, 0, 0xFFD6D8E3 )
		paint_replace_color( 61, 0, 0xFFD6D8E3 )
	else
		paint_replace_color( 60, 0, 0xFF33E311)
		paint_replace_color( 61, 0, 0xFF33E311)
	end
end

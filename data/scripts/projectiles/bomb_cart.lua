...
if EntityGetFirstComponentIncludingDisabled(entity_id,"VariableStorageComponent") then
...
if EntityGetFirstComponentIncludingDisabled(entity_id,"PhysicsJoint2MutatorComponent") then

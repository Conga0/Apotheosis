...
local kantele_songs = { 
	...
	worm = { "d", "e", "a", "e", "dis" },
	alchemy = { "f", "g", "f", "a2", "c" },
	fullhp = { "d", "e", "a", "d" }, --Doesn't work.. don't know why, probably for the same reason bomb doesn't
}
					...
					if ( name == "kantele_song_pos" ) then
						...
						if ( #b > 0 ) then
							...
							elseif ( current_note_pos == song_length ) and ( note == current_note ) then
								...
								elseif ( currsong == "fullhp" ) then
									do_fullhp_magic = true
								end

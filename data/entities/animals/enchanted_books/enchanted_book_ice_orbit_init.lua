...
local orbital_count = 10

for i=1,orbital_count do

    local eid = EntityLoad( "data/entities/animals/enchanted_books/enchanted_book_ice_barrier.xml", x, y )
...
for k=1,#comps
do local v = comps[k]
	if ComponentGetValue2(v,"script_source_file") == "data/entities/animals/enchanted_books/enchanted_book_ice_orbit_init.lua" then

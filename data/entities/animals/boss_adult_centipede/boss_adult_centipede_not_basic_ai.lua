...
function Stage3()
	...
	ComponentSetValue2( wormAiComp, "speed", 0.5 )
	ComponentSetValue2( wormAiComp, "speed_hunt", 0.5 )
...
--[[
	...
	ComponentSetValue2( wormAiComp, "direction_adjust_speed", 0.15/2 )
	ComponentSetValue2( wormAiComp, "direction_adjust_speed_hunt", 0.45/2 )    
end
...
do
    ...
    elseif (current_frame >= cooldown_frame) and laser_stage == 5 then -- done schmoovin

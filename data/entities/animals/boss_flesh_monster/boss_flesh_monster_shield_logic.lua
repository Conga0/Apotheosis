...
function damage_received( damage, desc, entity_who_caused, is_fatal )
	...
	for k=1,#comps
	do comp = comps[k]
		if ComponentGetValue2(comp,"name") == "shield_stuff" then
			vcomp = comp
	...
	local eid = EntityLoad( table.concat({"data/entities/animals/boss_flesh_monster/misc/shield_red.xml"}), pos_x, pos_y )

...
for i=1,count do
	...
	shoot_projectile_from_projectile( entity_id, "data/entities/animals/boss_water_lukki/projectiles/enlightened_laser_fireball.xml", px + Random( -5, 5 ), py + Random( -5, 5 ), vel_x, vel_y )
end

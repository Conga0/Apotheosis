...
if currentLang == "русский" then
  ...
  custom_seed_name = "Установить пользовательское семя"
  ...
  seasonal_forced_cirno_name = "Запустить 9Ball Day"
  seasonal_forced_cirno_desc = "Включен ли принудительно праздник 9Ball Day?"
